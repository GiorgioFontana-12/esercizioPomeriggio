...
<div class="jumbotron p-5 mb-4 bg-light rounded-3">
    <div class="container py-5">
        ...
        <h1 class="display-5 fw-bold">
            Benvenuti su Laravel+Bootstrap 5
        </h1>
        ...
        <a href="https://github.com/lambia/LC-20230627-laravel-template" class="btn btn-danger btn-lg" type="button">io sono un bottone un po diverso</a>
    </div>
</div>
